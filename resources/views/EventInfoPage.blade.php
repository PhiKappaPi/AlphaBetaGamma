...
<html>
	...
	<div class="container-fluid" style="text-align:center;display:table-cell;height:500px;background-color:#0d1e41">
		...
		<aside >
						<h1 class="primary-headers">Location Information</h1>
						<img src="{{URL::asset('img/CoolDoods.jpg')}}" style="float:right; height: 500px; margin: 0px 500px 10px 0px; padding:20px 20px 20px 20px; background-color:#202c4a; border-style: solid; border-width:2px">
		</aside>
		<section class="info">
				<div class="main">
				...
				<div>
								<h1 class="primary-headers">Costs</h1>
								<dl>
